  ...
  <main>
    <div class="question_page">
      ...
      <div class="layer" id="layer2">
        ...
        <img src="@/assets/mig/mozg.svg" alt="Layer 2 Image 2" class="layer-image mozg" />
...
main {
    ...
    background-repeat: no-repeat; /* Это предотвратит повторение фона */
    user-select: none;
}
...
.strlk {
    width: 8%; /* или другое относительное значение */
    position: absolute;
    top: 50%;
    left: 40%; /* Измените отступ справа по вашему усмотрению */
...
.options button {
    ...
    color: #FFFFFF;
    border-radius: 20px;
    font-size: 2em; /* Используем em для относительного размера шрифта */
    padding: 30px 70px;
    margin: 10px;
    overflow: hidden; /* Обрезаем текст, который не помещается внутри кнопки */
...
@media (max-width: 768px) {
    .cloud {
        max-width: 30%; /* Уменьшенная максимальная ширина для узких экранов */
    }
}
</style>
